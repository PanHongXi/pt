<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"E:\wamp64\www\pt\public/../application/admin\view\nav\navAdd.html";i:1533020977;s:56:"E:\wamp64\www\pt\application\admin\view\common\head.html";i:1532568131;s:56:"E:\wamp64\www\pt\application\admin\view\common\left.html";i:1533104370;}*/ ?>
<!DOCTYPE html>
<html><head>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <select name="pid" class=" form-control" data-live-search="true" data-size="10" tabindex="-98">
                                ...
                                <?php if(is_array($nav) || $nav instanceof \think\Collection || $nav instanceof \think\Paginator): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                                    <option value="<?php echo $nav['id']; ?>" title="<?php echo $nav['nav_name']; ?>"><?php echo str_repeat('&nbsp;',$nav['level'] * 2); ?><?php echo $nav['nav_name']; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <input id="name" name="nav_name" class="form-control" maxlength="200" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label item-required" for="name">路径:</label>
                        <div class="col-xs-9 col-sm-4">
                            <input id="url" name="url" class="form-control" maxlength="200" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <div class="checkbox checkbox-inline">
                                <input id="isPublication" name="position[]" checked="checked" type="checkbox" value="1">
                                <label for="isPublication">头部</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                                <input id="isTop" name="position[]" type="checkbox" value="2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <input id="order" name="orders" class="form-control" maxlength="9" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label">内容:</label>
                        <div class="col-xs-9 col-sm-10">
                            <textarea class="form-control" style="width: 540px;height: 80px"  id="content" name="content" ></textarea>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $('#tijiao').click(function () {
        ...
        $.ajax({
            type:"POST",
            url:"<?php echo url('admin/Nav/navAdd'); ?>",
            data:forData,
            dataType:"JSON",

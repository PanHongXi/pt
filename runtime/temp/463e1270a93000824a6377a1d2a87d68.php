<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\wamp64\www\pt\public/../application/admin\view\system\sAdd.html";i:1533107926;s:56:"E:\wamp64\www\pt\application\admin\view\common\head.html";i:1533108114;s:56:"E:\wamp64\www\pt\application\admin\view\common\left.html";i:1533104370;}*/ ?>
<!DOCTYPE html>
<html><head>
...
<main>
    <div class="container-fluid">
        ...
        <form class="form-horizontal" action="" id="tf" method="post" enctype="multipart/form-data">
            <div class="panel panel-default">
                <div class="panel-heading">添加设置</div>
                <div class="panel-body">

                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label item-required" for="name">名称:</label>
                        <div class="col-xs-9 col-sm-4">
                            <input id="name" name="sname" class="form-control" maxlength="200" type="text">
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    function test(){
        ...
        $.ajax({
            url:"<?php echo url('admin/System/sAdd'); ?>",
            type:"POST",
            data:form,
            processData:false,
            contentType:false,

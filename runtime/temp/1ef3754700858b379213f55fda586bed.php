<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\wamp64\www\pt\public/../application/admin\view\system\sList.html";i:1533108054;s:56:"E:\wamp64\www\pt\application\admin\view\common\head.html";i:1533108114;s:56:"E:\wamp64\www\pt\application\admin\view\common\left.html";i:1533104370;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-xs-12 col-sm-9">
                            <div class="btn-group">
                                <a class="btn btn-default" href="<?php echo url('admin/System/sAdd'); ?>" data-redirect-url="/admin/navigation/list">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                ...
                                <td>
                                    <a class="btn btn-default btn-xs btn-icon" href="<?php echo url('System/sEdit',array('id' => $list['id'])); ?>" title="编辑" data-toggle="tooltip" data-redirect-url>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\wamp64\www\pt\public/../application/admin\view\nav\navList.html";i:1532941855;s:56:"E:\wamp64\www\pt\application\admin\view\common\head.html";i:1533108114;s:56:"E:\wamp64\www\pt\application\admin\view\common\left.html";i:1533104370;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-xs-12 col-sm-9">
                            <div class="btn-group">
                                <a class="btn btn-default" href="<?php echo url('admin/Nav/navAdd'); ?>" data-redirect-url="/admin/navigation/list">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($navList) || $navList instanceof \think\Collection || $navList instanceof \think\Paginator): $i = 0; $__LIST__ = $navList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$navList): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td>
                                        <div class="checkbox">
                                            <input name="ids" type="checkbox" value="<?php echo $navList['id']; ?>">
                                            <label></label>
                                        </div>
                                    </td>
                                    <td><?php echo str_repeat('&nbsp;',$navList['level'] * 2); ?><?php echo $navList['nav_name']; ?></td>
                                    <td>
                                        <?php if($navList['show_nav'] == 1): ?>
                                        显示
                                        <?php else: ?>
                                        隐藏
                                        <?php endif; ?>
                                    ...
                                    <td>
                                        <?php if($navList['position'] == 1): ?>
                                        头部
                                        <?php else: ?>
                                        底部
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo $navList['orders']; ?></td>
                                    <td>
                                        <a class="btn btn-default btn-xs btn-icon" href="<?php echo url('Nav/navEdit',array('id' => $navList['id'])); ?>" title="编辑" data-toggle="tooltip" data-redirect-url>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\wamp64\www\pt\public/../application/admin\view\product\padd.html";i:1533003984;s:56:"E:\wamp64\www\pt\application\admin\view\common\head.html";i:1532568131;s:56:"E:\wamp64\www\pt\application\admin\view\common\left.html";i:1533007186;}*/ ?>
...
<main>
    <div class="container-fluid">
        ...
        <form class="form-horizontal" id="tf" enctype="multipart/form-data" action="" method="post">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <input id="name" name="pname" class="form-control" type="text" maxlength="200">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <input id="order" name="orders" class="form-control" type="text" maxlength="9">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <div class="checkbox checkbox-inline">
                                <input id="isPublication" name="enable" checked="checked" type="checkbox" value="1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <div class="checkbox checkbox-inline">
                                <input id="recom" name="recom" checked="checked" type="checkbox" value="1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-10">
                            <textarea  id="content" name="pdesc" ></textarea>
                        </div>
                    </div>
                </div>
...
<script>
    function prot(){
        ...
        $.ajax({
            url:"<?php echo url('admin/Product/padd'); ?>",
            type:"POST",
            data:form,
            processData:false,
            contentType:false,

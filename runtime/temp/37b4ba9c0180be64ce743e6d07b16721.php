<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"E:\wamp64\www\pt\public/../application/admin\view\link\lEdit.html";i:1533105782;s:56:"E:\wamp64\www\pt\application\admin\view\common\head.html";i:1532568131;s:56:"E:\wamp64\www\pt\application\admin\view\common\left.html";i:1533104370;}*/ ?>
<!DOCTYPE html>
<html><head>
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <input id="name" name="name" value="<?php echo $info['name']; ?>" class="form-control" maxlength="200" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label item-required" for="name">链接地址:</label>
                        <div class="col-xs-9 col-sm-4">
                            <input id="" name="url" value="<?php echo $info['url']; ?>" class="form-control" maxlength="200" type="text">
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    function test(){
        ...
        $.ajax({
            url:"<?php echo url('admin/Link/lEdit'); ?>",
            type:"POST",
            data:form,
            processData:false,
            contentType:false,

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\wamp64\www\pt\public/../application/admin\view\system\sEdit.html";i:1533107932;s:56:"E:\wamp64\www\pt\application\admin\view\common\head.html";i:1533108114;s:56:"E:\wamp64\www\pt\application\admin\view\common\left.html";i:1533104370;}*/ ?>
<!DOCTYPE html>
<html><head>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <input id="name" name="sname" value="<?php echo $info['sname']; ?>" class="form-control" maxlength="200" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <select name="show_nav" class=" form-control" data-live-search="true" data-size="10" tabindex="-98">
                                <option value="1" <?php if($info['show_nav'] == 1): ?>selected="selected"<?php endif; ?>>显示</option>
                                <option value="0" <?php if($info['show_nav'] == 0): ?>selected="selected"<?php endif; ?>>隐藏</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-sm-4">
                            <input id="order" name="orders" value="<?php echo $info['orders']; ?>" class="form-control" maxlength="9" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 col-sm-2 control-label">内容:</label>
                        <div class="col-xs-9 col-sm-10">
                            <textarea class="form-control" style="width: 540px;height: 80px"  id="content" name="content" ><?php echo $info['content']; ?></textarea>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    function test(){
        ...
        $.ajax({
            url:"<?php echo url('admin/System/sEdit'); ?>",
            type:"POST",
            data:form,
            processData:false,
            contentType:false,
